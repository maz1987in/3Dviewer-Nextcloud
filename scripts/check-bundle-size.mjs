...
const BUDGETS = [
  ...
  { pattern: /^App-.*\.chunk\.mjs$/, name: 'app', maxRaw: 345000, maxGzip: 93000 }, // Main app component (includes clipping plane + 6-plane clipping box, lighting, bookmarks, timeline, volume/surface area, annotation JSON I/O, scene diff overlay, annotation backend persistence, file browser search & filters)
