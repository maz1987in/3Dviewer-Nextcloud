...
const BUDGETS = [
  ...
  { pattern: /^App-.*\.chunk\.mjs$/, name: 'app', maxRaw: 325000, maxGzip: 89000 }, // Main app component (includes clipping, lighting, bookmarks, timeline, volume/surface area, annotation JSON I/O)
