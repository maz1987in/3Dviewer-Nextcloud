...
const BUDGETS = [
  ...
  { pattern: /^App-.*\.chunk\.mjs$/, name: 'app', maxRaw: 332000, maxGzip: 91000 }, // Main app component (includes clipping, lighting, bookmarks, timeline, volume/surface area, annotation JSON I/O, scene diff overlay, annotation backend persistence)
