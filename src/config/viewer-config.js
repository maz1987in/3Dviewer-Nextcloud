...
export const SUPPORTED_FORMATS = {
	...
	gco: {
		name: 'GCO',
		description: 'G-code (alternate extension)',
		mimeType: 'text/x-gcode',
		features: ['toolpath', 'layers', 'cnc'],
		multiFile: false,
		displayOrder: 14,
	...
	gx: {
		name: 'GX',
		description: 'FlashForge GX format',
	...
	thing: {
		name: 'THING',
		description: 'MakerBot Thing format',
		mimeType: 'application/x-gcode',
		features: ['toolpath', 'layers'],
		multiFile: false,
		displayOrder: 21,
	...
	step: {
		name: 'STEP',
		description: 'STEP (ISO 10303) CAD format',
		mimeType: 'model/step',
		features: ['cad', 'nurbs', 'assemblies'],
		multiFile: false,
		displayOrder: 27,
		icon: imagePath('threedviewer', 'filetypes/step.svg'),
	},
	stp: {
		name: 'STP',
		description: 'STEP (alternative extension)',
		mimeType: 'model/step',
		features: ['cad', 'nurbs', 'assemblies'],
		multiFile: false,
		displayOrder: 28,
		icon: imagePath('threedviewer', 'filetypes/stp.svg'),
	},
	iges: {
		name: 'IGES',
		...
		multiFile: false,
		displayOrder: 29,
		icon: imagePath('threedviewer', 'filetypes/iges.svg'),
	},
	igs: {
		name: 'IGS',
		description: 'IGES (alternative extension)',
		mimeType: 'model/iges',
		features: ['cad', 'nurbs'],
		multiFile: false,
		displayOrder: 30,
		icon: imagePath('threedviewer', 'filetypes/igs.svg'),
	},
	brep: {
		name: 'BREP',
		description: 'OpenCascade native B-Rep',
		mimeType: 'model/brep',
		features: ['cad', 'nurbs'],
		multiFile: false,
		displayOrder: 31,
		icon: imagePath('threedviewer', 'filetypes/brep.svg'),
	},
	brp: {
		name: 'BRP',
		description: 'BREP (alternative extension)',
		mimeType: 'model/brep',
		features: ['cad', 'nurbs'],
		multiFile: false,
		displayOrder: 32,
		icon: imagePath('threedviewer', 'filetypes/brp.svg'),
	},
	fcstd: {
		name: 'FCSTD',
		description: 'FreeCAD document',
		mimeType: 'application/x-fcstd',
		features: ['cad', 'assemblies', 'brep'],
		multiFile: false,
		displayOrder: 33,
		icon: imagePath('threedviewer', 'filetypes/fcstd.svg'),
	},
}
